function perturb_hopf_syncbynode_UWS(node)
...
we= 0.04;  %% Insert here G value from optimal UWS model fitting
ITER=10;
N=214;
a=-0.02*ones(N,2);
...
save(sprintf('UWS_KLpstates_perturbed_syncProt_bynode_%s',num2str(node)),'PTRsim_perturbed','KLpstatesUWS_perturbed_Control','KLpstatesUWS_perturbed_MCS','PTRsim','Pstates_perturbed','Pstates')
