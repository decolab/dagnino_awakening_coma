function perturb_hopf_noisebynode_MCS(node)

load Modelling_Workspace_MCS.mat


PERTURB=0:-0.02:-0.2; % Noise protocol.
...
save(sprintf('MCS_KLpstates_perturbed_noiseProt_bynode_%s',num2str(node)),'PTRsim_perturbed','KLpstatesMCS_perturbed','PTRsim','Pstates_perturbed','Pstates')
